...
// Bring in Apollo GraphQL Server
...
// import { entrySchema } from './graphql/schema';
...
require('./methods/passport')(passport);
// Passport Middleware
...
// Setting up our Apollo graphQL server
app.use('/graphql', bodyParser.json(), graphqlExpress({ schema: graphqlSchema, graphiql: true }));
// And graphiql
app.use(
  '/graphiql',
  graphiqlExpress({
